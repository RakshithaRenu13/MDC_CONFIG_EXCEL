...
# ------------------------------------------------------------
EMBEDDED_DATABASE = {'configs': {'Config 1': {'title': '', 'bom': []}, 'Config 3': {'title': 'SOLUTION 3  (7 kw Cooling W/o Dehumidifier)', 'bom': [{'part_number': 'CTO3M002', 'description': 'SINGLE RACK MDC, 7kW Cooling Unit, Without Dehumidifier', 'quantity': 1, 'uom': 'EA'
